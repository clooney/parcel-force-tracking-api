Parcelforce Tracking API - Java
================================
Use Java to track Parcelforce shipments with Parcelforce Tracking API.

Features
--------
- Real-time Parcelforce tracking.
- Batch Parcelforce tracking.
- Other features to manage your Parcelforce tracking.
...
Then, start to track your Parcelforce shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.parcelforce;
    ...
    public class CreateParcelForceTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("parcel-force");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateParcelForceTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetParcelForceTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("parcel-force");
...
Update a tracking by ID:
    ...
    public class UpdateParcelForceTrackingExample {
